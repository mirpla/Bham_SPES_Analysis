...
function [CSCHippCondLFP, SPKcondLFP, TrialSelCondLFP, TrialSelCondiEEG, ICConditions] = SelectedConditions_IEEG_I_LFP(AllMicro, AllMacro)
% 
% cfg = [];
...
for k = 1:length(AllMicro.Session)
    LFPData{1,1} = AllMicro.Session{1,k};
    LFPData{2,1} = AllMicro.SessionNorm{1,k};
    %LFPData{3,1} = AllMicro.MUAs{1,k};
    
    for b = 1:length(LFPData)
        %%
        clear TrialSelCondLFP
        if ~isempty(AllMicro.SubjID{1,k})
            
            switch AllMicro.SubjID{1,k}
                ...
                case 'P12'
                    LocalChanLAHLFP  = LFPSelChans{10,1};
                    LocalChanLMHLFP  = LFPSelChans{10,2};
                ...
                case 'P06'
                    LocalChanLAHLFP  = LFPSelChans{11,1};
                ...
                case 'P062'
                    LocalChanLAHLFP  = LFPSelChans{12,1};
                    LocalChanLMHLFP  = LFPSelChans{12,2};
                    LocalChanLPHLFP  = LFPSelChans{12,3};
...
if q == 1
    ...
    for k = 1:length(AllMacro.Session)
        iEEGData = AllMacro.Session{1,k};
        %%
        switch AllMacro.SubjID{1,k}
            
            case 'P07'
                LocalCtxChanAHiEEG  = SelChansiEEG{k,1};
                LocalCtxChanMHiEEG  = SelChansiEEG{k,2};
                LocalCtxChanPHiEEG  = SelChansiEEG{k,3};
                LocalHippChanAHiEEG  = SelChansiEEG{k,4};
                LocalHippChanMHiEEG  = SelChansiEEG{k,5};
                LocalHippChanPHiEEG  = SelChansiEEG{k,6};
