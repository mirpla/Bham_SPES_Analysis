...
function h = rm_raincloud(data,SE, colours, plot_top_to_bottom, density_type, bandwidth,raindrop_size,mean_size, box_on)
...
for i = 1:n_plots_per_series - 1 % We have n_plots_per_series-1 lines because lines connect pairs of points
    for j = 1:n_series
        ...
        h.l(i, j) = line(cell_means([i i+1], j), posi, 'LineWidth', 4, 'Color', [colours(j, :),0.5]);
